...
describe('CarsService', () => {
  ...
  it('should append a car', () => {
    ...
    const carToAppend: INewCar = { make: 'test', model: 'test2', year: 1900, color: 'upick', price: 1 };
    const carAppended: ICar = { ...carToAppend, id: 1  };
  ...
  it('should replace a car', () => {
    ...
    const newCar: ICar = { ...originalCar, id: 1, color: 'red' };
